...
<a href="https://rstudio.cloud/project/1528737" target="_blank">
  <button class="rstudio-cloud-btn">
    <i class="fa fa-cloud"> &#160; &#160; </i>
      Open in RStudio Cloud
  </button>
</a>
...
<center>[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/dsvancer/gbus-738-r-tutorials/master?urlpath=rstudio){target="_blank"}</center>
...
It looks like our linear regression model does really well for homes with actual selling prices between \$250,000 and \$1,000,000. Outside of this range, our model has rather large errors. In fact, for some homes with selling prices of less than \$220,000, our model predicts a negative selling price! 

This is why it's important to always make an R2 plot and analyze your model's errors. 
